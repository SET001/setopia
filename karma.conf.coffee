...
module.exports = (config) ->
  config.set
    ...
    files: [
        ...
        "app/client/services/sectors/sector.coffee"
        "app/client/services/sectors/basicSectorSpawner.coffee"
        "app/client/services/sectors/forestSectorSpawner.coffee"
        "app/client/services/sectors/sectorsManager.coffee"
        "specs/sector.coffee"
